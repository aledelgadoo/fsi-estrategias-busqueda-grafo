...
def correr_experimento_opcional():
...
if __name__ == "__main__":
    while True:
        print("\n" + "="*40)
        print("      MENÚ PRÁCTICA 1 - FSI")
        print("="*40)
        print("1. Test General (Tabla Parte 3)")
        print("2. Heurística que sobreestima (Opcional)")
        print("3. Salir")
        ...
        try:
            ...
            if opcion == 1:
                correr_pruebas_standard()
                input("\nPresiona ENTER para continuar...")
            
            elif opcion == 2:
                correr_experimento_opcional()
                input("\nPresiona ENTER para continuar...")
                ...
                print("⚠ Opción desconocida. Elige 1, 2 o 3.")
